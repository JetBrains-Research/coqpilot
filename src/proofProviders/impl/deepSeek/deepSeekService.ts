...
export class DeepSeekService extends ProofProvider<
...
> {
    ...
    readonly identifier = ProofProviderIdentifier.DEEPSEEK;
...
export class DeepSeekGeneratedProof extends GeneratedProof<
    DeepSeekModelParams,
    DeepSeekService,
    DeepSeekGeneratedProof,
    DeepSeekServiceInternal
> {
    constructor(
        ...
        proofProviderInternal: DeepSeekServiceInternal,
...
class DeepSeekServiceInternal extends ProofProviderInternal<
    DeepSeekModelParams,
    DeepSeekService,
    DeepSeekGeneratedProof,
    DeepSeekServiceInternal
