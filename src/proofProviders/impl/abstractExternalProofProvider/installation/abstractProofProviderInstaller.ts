...
export abstract class AbstractProofProviderInstaller<
    InstallationOptions,
...
> {
    ...
    getDefaultInstallationPath(): string {
        return AbstractExternalProofProvider.getDefaultInstallationPath(
    ...
    detectOutdatedInstallations(
        ...
        return listFiles(installationDirPath, 0, (filePath) => {
            ...
            return (
                fileName.startsWith(
                    AbstractExternalProofProvider.getDefaultInstallationDirPrefix(
                        this.externalProjectName
                    )
