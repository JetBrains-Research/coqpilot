...
export class GrazieService implements LLMServiceInterface {
    ...
    private createHistory = (proofGenerationContext: ProofGenerationContext, systemMessage: string): GrazieFormattedHistory => {
        ...
        formattedHistory.push({ role: 'User', text: proofGenerationContext.admitCompletionTarget });
    ...
    async generateProof(
        ...
        const grazieFormattedHistory = this.createHistory(proofGenerationContext, params.prompt);
