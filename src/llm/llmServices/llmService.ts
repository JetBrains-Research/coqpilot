 ...
 * is required inside implementation only.
 * Thus, outside of the internal implementation, this class will most likely be parameterized with `any`-s.
 */
export type GeneratedProof = GeneratedProofImpl<any, any, any, any>;
