...
import {
    ...
    SingleParamResolver,
} from "../../../../proofProviders/impl/utils/paramsResolvers/abstractResolvers";
import { ResolutionActionResult } from "../../../../proofProviders/impl/utils/paramsResolvers/abstractResolvers";
import {
    SingleParamResolverBuilder,
    ValidationRules,
    newParam,
    resolveParam,
} from "../../../../proofProviders/impl/utils/paramsResolvers/builders";

import {
    ResolutionResultAddOns,
    expectParamResolutionResult,
} from "../../proofProvidersSpecificTestUtils/expectResolutionResult";

suite("[ProofProvider-s utils] Test single parameter resolution", () => {
