...
import { estimateTimeToBecomeAvailableDefault } from "../../../proofProviders/impl/utils/defaultAvailabilityEstimator";
import {
    LoggerRecord,
    ResponseStatus,
...
suite("[ProofProvider] Test default availability estimator", () => {
